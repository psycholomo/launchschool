...
#:occupation, and the appropriate values. Your method should return a greeting that uses the person's full name, and mentions the person's title.
...
def greetings(array, hash)
  ...
  puts "Hello #{new_string}! Nice to have a #{hash[:title]} #{hash[:occupation]} around."
end
